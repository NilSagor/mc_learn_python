...
# loading the data & splitting the data randomly for train and test
...
# the square root of the sum of the squared differeance of the two arrays of numbers
...
if __name__ == '__main__':
	...
	test = []
	split = 0.67
	loadDataset('iris.data', split, train, test)
